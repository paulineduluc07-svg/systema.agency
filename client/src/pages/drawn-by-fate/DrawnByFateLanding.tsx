...
export default function DrawnByFateLanding() {
  ...
  function goToReading(q: string, s: string) {
    ...
    if (s) params.set("s", s);
    navigate(`/drawn-by-fate/reading?${params.toString()}`);
  }
        ...
        >
          ...
          <div style={{ display: "flex", justifyContent: "flex-end", marginTop: 10 }}>
            <button
              ...
              onMouseEnter={(e) => question.trim() && ((e.currentTarget as HTMLElement).style.background = "#CC0000")}
              onMouseLeave={(e) => question.trim() && ((e.currentTarget as HTMLElement).style.background = "#8B0000")}
            >
              Révéler
            </button>
          </div>
